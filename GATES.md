...
- [x] G0: Public competitive-landscape table audits roughly ten vendors against CFO unit-economics criteria and applies the fixed positioning rule
  ...
  EVIDENCE: exit 0; as_of=2026-09-01, vendors=10, vendor_evidence_sections=10, source_urls=68, unique_source_urls=50, strict_cfo_vendors=0/10. Source availability check: 47 unique URLs returned HTTP 200 to HEAD and the remaining 3 returned HTTP 200 to GET fallback; no final source check was non-200. Decision under the contract: 0–1 vendors ship CFO-facing unit economics, so retain the “almost none” positioning. Public artifact: https://github.com/1deat0r/agent-finops-meter/blob/main/research/vendor-audit.md; publication_commit=https://github.com/1deat0r/agent-finops-meter/commit/7eca7d6
